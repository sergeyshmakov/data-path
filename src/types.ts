 ...
 */
export type CollectionItem<V> = V extends ReadonlyArray<infer U>
    ? U
 ...
 */
export interface BasePath<T = unknown, V = unknown, _P extends string = string> {
    /**
 ...
 */
export type Path<T = unknown, V = unknown, P extends string = string> = 
    BasePath<T, V, P> & 
 ...
 */
export type TemplatePath<T = unknown, V = unknown, P extends string = string> = 
