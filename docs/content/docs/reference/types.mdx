...
`WILDCARD` and `DEEP_WILDCARD` are exported when you need to construct a template from a raw segment array (for example, to round-trip through JSON — see [Templates](/guides/templates/)).
