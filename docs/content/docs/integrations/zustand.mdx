...
- [Data access](/guides/data-access/) — `set`, `update`, and how structural clones work
- [Path algebra](/guides/path-algebra/) — `to` for composing paths from a common base
- [React `useState`](/integrations/react-usestate/) — the same pattern for local component state
