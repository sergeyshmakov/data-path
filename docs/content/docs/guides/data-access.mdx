...
- [Templates](/guides/templates/) — bulk reads and writes across collections
- [Path Algebra](/guides/path-algebra/) — compose and decompose paths
- [Runtime Variables](/guides/runtime-variables/) — indices and closures inside lambdas
