...
hero:
  ...
  actions:
    - text: Quick Start
      link: /data-path/getting-started/quick-start/
      icon: right-arrow
      variant: primary
    - text: View on GitHub
