...
- [Data access](/guides/data-access/) — `update`, `fn`, and safe traversal details
- [Templates](/guides/templates/) — bulk reads and writes with `each` and `deep`
- [Path algebra](/guides/path-algebra/) — compose and decompose paths
- [Integrations](/integrations/react-hook-form/) — ready-made patterns for React Hook Form, Zustand, and more
