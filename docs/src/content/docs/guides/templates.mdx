...
- [Data access](/data-path/guides/data-access/) — `get`, `set`, `update` on concrete paths
- [Runtime Variables](/data-path/guides/runtime-variables/) — dynamic indices as an alternative to wildcards
